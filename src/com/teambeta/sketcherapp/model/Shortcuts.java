...
public class Shortcuts {
    ...
    public static final String HUE_SATURATION_SHORTCUT = "SATURATION";
    ...
    public static String getHueSaturationShortcut() {
        return HUE_SATURATION_SHORTCUT;
    }
